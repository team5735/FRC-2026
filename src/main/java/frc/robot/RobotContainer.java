...
public class RobotContainer {
    ...
    public static final CommandXboxController subsystemController =
        new CommandXboxController(Constants.SUBSYSTEM_CONTROLLER_PORT);

    public static final CommandXboxController testController =
        new CommandXboxController(Constants.TEST_CONTROLLER_PORT);

    private final SendableChooser<Command> autoChooser;

    private final Telemetry logger = new Telemetry();

    public static final DrivetrainSubsystem drivetrain = switch (
        Constants.DRIVETRAIN_TYPE
    ) {
    ...
    public static final FuelLauncherSubsystem launcher =
        new FuelLauncherSubsystem();
            ...
            new PIDToPose(
                ...
                () -> {
                    ...
                    drivetrain.resetPose(
                        limelights[1].new PoseEstimate().pose2d
                    );
                    return pos;
                },
                "stay in place !",
    ...
    public static Arc targetArc = new Arc(
    ...
    private void configureBindings() {
        ...
        hood.exclusionZoneTrigger.onTrue(
            Commands.runOnce(() -> {
        ...
        hood.exclusionZoneTrigger.onFalse(
            Commands.runOnce(() -> {
        ...
        driveController
            .a()
            .onTrue(Commands.runOnce(() -> hood.setHoodPosition(0.3)));
        ...
        launcher.setDefaultCommand(
            launcher.getLaunchFuel(RPM.of(0), RPM.of(0))
        );
        ...
        testController
            .a()
            .whileTrue(
                launcher.getFedLaunch(spindex, RPM.of(3000), RPM.of(24))
            );
        testController
            .b()
            .whileTrue(
                launcher.getFedLaunch(spindex, RPM.of(1500), RPM.of(12))
            );
        testController
            .x()
            .whileTrue(
                launcher.getFedLaunch(spindex, RPM.of(6000), RPM.of(48))
            );
