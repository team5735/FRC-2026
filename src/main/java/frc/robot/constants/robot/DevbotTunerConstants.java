...
public class DevbotTunerConstants {
    ...
    public static final Slot0Configs DEFAULT_STEER_CONSTANTS = new Slot0Configs()
            .withKP(67.5).withKI(0).withKD(0.2)
            .withKS(0.09).withKV(2.4).withKA(0.125)
    ...
    private static final Current SLIP_CURRENT = Amps.of(35.0);
    ...
    public static DrivetrainSubsystem createDrivetrain() {
        return new DrivetrainSubsystem(
                DRIVETRAIN_CONSTANTS, new DevbotConstants(), FL_CONSTANTS, FR_CONSTANTS, BL_CONSTANTS, BR_CONSTANTS);
    }
