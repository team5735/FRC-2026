...
public class FieldConstants {
    ...
    // This is to the front of the uprights, which are a little further ahead than the rungs,
    // and a little further back than the climbing structure floor (see pdf for details)
    ...
    public static final Distance CLIMBER_HOOK_MIN_Z = TOWER_DIMENSION.getMeasureZ().plus(TOWER_RUNG_OD.div(2.0)).plus(inch(0.25));
